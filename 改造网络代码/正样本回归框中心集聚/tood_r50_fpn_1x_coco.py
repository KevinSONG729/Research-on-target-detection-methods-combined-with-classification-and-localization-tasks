...
work_dir = './work_dirs/tood_r50_fpn_1x_coco_disloss_dislossPredCenter'
checkpoint_config = dict(interval=1, max_keep_ckpts=8, out_dir='checkpoints/tood_r50_fpn_1x_coco_disloss_dislossPredCenter')
