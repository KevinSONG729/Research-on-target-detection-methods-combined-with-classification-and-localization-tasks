...
train_cfg = dict(
    ...
    assigner=dict(type='TaskAlignedAssignerSemantic', topk=13),
    alpha=1,
    beta=6,
    allowed_border=-1,
    pos_weight=-1,
...
work_dir = './work_dirs/tood_r50_fpn_1x_coco_semantic'
checkpoint_config = dict(interval=1, max_keep_ckpts=8, out_dir='checkpoints/tood_r50_fpn_1x_coco_semantic')
