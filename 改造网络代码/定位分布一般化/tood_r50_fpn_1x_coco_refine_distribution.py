...
work_dir = './work_dirs/tood_r50_fpn_1x_coco_refine_distribution'
checkpoint_config = dict(interval=1, max_keep_ckpts=12, out_dir='checkpoints/tood_r50_fpn_1x_coco_refine_distribution')
