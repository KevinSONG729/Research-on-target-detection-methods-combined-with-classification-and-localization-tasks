...
logging.basicConfig(level=logging.DEBUG,
                    format='%(message)s',
                    filename='/root/autodl-tmp/code/work_dirs/tood_r50_fpn_1x_coco_topk256_analysis/topk_analysis.log',
                    filemode='w')
...
class TOODHead_topk256_analysis(ATSSHead):
    ...
    def __init__(self,
        ...
        super(TOODHead_topk256_analysis, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def _get_target_single(self,
        ...
        """
        logging.debug("image name is " + img_meta['filename'])
