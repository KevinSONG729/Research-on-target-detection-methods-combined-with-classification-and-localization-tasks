...
class TaskDecomposition(nn.Module):
    ...
    def forward(self, feat, avg_feat=None):
        ...
        weight = self.channel_attention(avg_feat)
        ...
        conv_weight = weight.reshape(
            b, self.feat_channels, self.stacked_convs,
...
class TOODHead_CHANNEL_ATTENTION(ATSSHead):
    ...
    def __init__(self,
        ...
        super(TOODHead_CHANNEL_ATTENTION, self).__init__(num_classes, in_channels, **kwargs)
