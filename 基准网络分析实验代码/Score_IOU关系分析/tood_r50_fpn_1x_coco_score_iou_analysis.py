...
work_dir = '/root/autodl-tmp/code/work_dirs/tood_r50_fpn_1x_score_iou_analysis'
...
resume_from = '/root/autodl-tmp/code/checkpoints/tood_r50_fpn_1x_coco_ref/epoch_12.pth'
